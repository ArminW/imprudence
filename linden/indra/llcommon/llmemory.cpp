...
const char* LLMemType::sTypeDesc[LLMemType::MTYPE_NUM_TYPES] =
{
	...
	"VERTEX_CONSTRUCTOR",
	"VERTEX_DESTRUCTOR",
	"VERTEX_CREATE_VERTICES",
	"VERTEX_CREATE_INDICES",
	"VERTEX_DESTROY_BUFFER",	
	"VERTEX_DESTROY_INDICES",
	"VERTEX_UPDATE_VERTS",
	"VERTEX_UPDATE_INDICES",
	"VERTEX_ALLOCATE_BUFFER",
	"VERTEX_RESIZE_BUFFER",
	"VERTEX_MAP_BUFFER",
	"VERTEX_MAP_BUFFER_VERTICES",
	"VERTEX_MAP_BUFFER_INDICES",
	"VERTEX_UNMAP_BUFFER",
	"VERTEX_SET_STRIDE",
	"VERTEX_SET_BUFFER",
	"VERTEX_SETUP_VERTEX_BUFFER",
	"VERTEX_CLEANUP_CLASS"

	"PIPELINE"
	"PIPELINE_INIT"
	"PIPELINE_CREATE_BUFFERS"
	"PIPELINE_RESTORE_GL"
	"PIPELINE_UNLOAD_SHADERS"
	"PIPELINE_LIGHTING_DETAIL"
	"PIPELINE_GET_POOL_TYPE"
	"PIPELINE_ADD_POOL"
	"PIPELINE_ALLOCATE_DRAWABLE"
	"PIPELINE_ADD_OBJECT"
	"PIPELINE_CREATE_OBJECTS"
	"PIPELINE_UPDATE_MOVE"
	"PIPELINE_UPDATE_GEOM"
	"PIPELINE_MARK_VISIBLE"
	"PIPELINE_MARK_MOVED"
	"PIPELINE_MARK_SHIFT"
	"PIPELINE_SHIFT_OBJECTS"
	"PIPELINE_MARK_TEXTURED"
	"PIPELINE_MARK_REBUILD"
	"PIPELINE_UPDATE_CULL"
	"PIPELINE_STATE_SORT"
	"PIPELINE_POST_SORT"
		
	"PIPELINE_RENDER_HUD_ELS"
	"PIPELINE_RENDER_HL"
	"PIPELINE_RENDER_GEOM"
	"PIPELINE_RENDER_GEOM_DEFFERRED"
	"PIPELINE_RENDER_GEOM_POST_DEF"
	"PIPELINE_RENDER_GEOM_SHADOW"
	"PIPELINE_RENDER_SELECT"
	"PIPELINE_REBUILD_POOLS"
	"PIPELINE_QUICK_LOOKUP"
	"PIPELINE_RENDER_OBJECTS"
	"PIPELINE_GENERATE_IMPOSTOR"
	"PIPELINE_RENDER_BLOOM"
