										  ...
										  LLDataPacker *dp)
{
	...
	if (0 == mTreeImagep->getFullWidth()*mTreeImagep->getFullHeight())
	{
		mTreeImagep = LLViewerTextureManager::getFetchedTextureFromFile(
										sSpeciesTable[mSpecies]->mTextureName,
										TRUE,
