...
private:
	...
	// UI Callbacks 
	static void onClickEnableAll(void* userdata);
	static void onClickDisableAll(void* userdata);
	static void onClickEnableParcelMedia(void* userdata);
	static void onClickDisableParcelMedia(void* userdata);
	static void onClickMuteParcelMedia(void* userdata);
	static void onParcelMediaVolumeSlider(void* userdata);
	static void onClickParcelMediaPlay(void* userdata);
	static void onClickParcelMediaStop(void* userdata);
	static void onClickParcelMediaPause(void* userdata);
	static void onClickParcelAudioPlay(void* userdata);
	static void onClickParcelAudioStop(void* userdata);
	static void onClickParcelAudioStart(void* userdata);
	static void onClickParcelAudioPause(void* userdata);
	static void onCheckAutoPlay(void* userdata);
	static void onAdvancedButtonClick(void* userdata);	
	static void onMoreLess(void* userdata);	
	
// 	static void onCheckItem(LLUICtrl* ctrl, const LLUUID &row_id);
...
private:
	...
	static void onClickSelectedMediaStop(void* userdata);
	static void onClickSelectedMediaPlay(void* userdata);
	static void onClickSelectedMediaPause(void* userdata);
	static void onClickSelectedMediaMute(void* userdata);
	static void onCommitSelectedMediaVolume(void* userdata);
	static void onClickSelectedMediaZoom(void* userdata);
	static void onClickSelectedMediaUnzoom(void* userdata);
